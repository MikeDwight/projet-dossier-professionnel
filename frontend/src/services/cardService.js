...
export const fetchUserCards = () => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield fetch(`${API_URL}/userId`, { credentials: "include" });
    return response.json();
});
export const addCard = (newCard) => __awaiter(void 0, void 0, void 0, function* () {
...
export const updateCard = (cardId, updatedCard) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield fetch(`${API_URL}/${cardId}`, {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
